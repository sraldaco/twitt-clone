...
var o__26720__auto___29887 = (function (){var o__26720__auto__ = (function (){var o__26720__auto__ = Promise;
return (o__26720__auto__["resolve"]).call(o__26720__auto__);
})();
return (o__26720__auto__["then"]).call(o__26720__auto__,callback);
})();
(o__26720__auto___29887["catch"]).call(o__26720__auto___29887,devtools.async.rethrow_outside_promise);
...
var G__29885_29888 = Error;
var target__26726__auto___29889 = G__29885_29888;
if(cljs.core.truth_(target__26726__auto___29889)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29885_29888)].join(''),"\n","target__26726__auto__"].join('')));
}

(target__26726__auto___29889["stackTraceLimit"] = Infinity);
