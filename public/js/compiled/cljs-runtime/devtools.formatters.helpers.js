...
var G__28746 = devtools.prefs.pref(v);
v = G__28746;
continue;
} else {
return v;
...
}catch (e28701){var _e__26728__auto__ = e28701;
return false;
}})();
...
}catch (e28706){var _e__26728__auto__ = e28706;
return false;
}})();
...
}catch (e28708){var _e__26728__auto__ = e28708;
return false;
}}
}
});
...
var vec__28723 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28723,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28723,(1),null);
...
return cljs.core.some((function (p1__28729_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28729_SHARP_);
}),template);
});
