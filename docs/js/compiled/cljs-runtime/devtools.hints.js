...
var G__26380 = cljs.core.PersistentArrayMap.EMPTY;
var G__26381 = native_stack_trace;
var G__26382 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__26383 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__26380,G__26381,G__26382,G__26383) : cljs.stacktrace.parse_stacktrace.call(null,G__26380,G__26381,G__26382,G__26383));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26385__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26385__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26385__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26384){var _e = e26384;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___26400 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___26400)){
var seen_errors_26401 = temp__5718__auto___26400;
if(cljs.core.truth_(seen_errors_26401.has(self))){
} else {
seen_errors_26401.add(self);

var temp__5720__auto___26402 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___26402)){
var sense_26403 = temp__5720__auto___26402;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26403)].join('');
} else {
}
}
} else {
