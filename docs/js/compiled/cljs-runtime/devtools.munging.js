...
var o28551 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28551["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28552 = temp__5718__auto____$1;
return (o28552["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26720__auto__ = f;
return (o__26720__auto__["toString"]).call(o__26720__auto__);
} else {
return "";
}
}catch (e28553){var _ = e28553;
return "";
}});
...
try{var o__26720__auto___28696 = t;
(o__26720__auto___28696["cljs$lang$ctorPrWriter"]).call(o__26720__auto___28696,t,writer);
}catch (e28554){var __28697 = e28554;
}
...
var char_code = (function (){var o__26720__auto__ = (new String(char$));
return (o__26720__auto__["charCodeAt"]).call(o__26720__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26720__auto__ = String;
return (o__26720__auto__["fromCharCode"]).call(o__26720__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28559 = num_code;
switch (G__28559) {
case (1):
return (185);
...
var o__26720__auto__ = String;
return (o__26720__auto__["fromCharCode"]).call(o__26720__auto__,superscript_code);
});
/**
...
}catch (e28566){var _e__26728__auto__ = e28566;
return false;
}})())){
...
var vec__28567 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28567,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28571 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28571["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28572 = temp__5718__auto____$1;
return (o28572["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28575){
var vec__28576 = p__28575;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28576,(0),null);
...
var G__28733 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28734 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28733;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28573){
var G__28574 = cljs.core.first(seq28573);
var seq28573__$1 = cljs.core.next(seq28573);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28574,seq28573__$1);
});
...
var vec__28581 = cljs.core.split_with((function (p1__28580_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28580_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28581,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28581,(1),null);
...
var vec__28591 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28591,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28591,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28743 = cljs.core.rest(remaining_tokens);
var G__28744 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28743;
name_tokens = G__28744;
continue;
} else {
...
var vec__28596 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28596,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28596,(1),null);
var vec__28599 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28599,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28599,(1),null);
var vec__28602 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28602,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28602,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28602,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28602,(3),null);
...
var vec__28611 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28611,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28611,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28611,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28611,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28611,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28611,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28614 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28614,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28614,(1),null);
var vec__28617 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28617,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28617,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28620 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28620) : devtools.munging.parse_fn_info_deep.call(null,G__28620));
})()));
}
} else {
return fn_info;
...
var G__28755 = (arity + (1));
var G__28756 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28632){
var vec__28633 = p__28632;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28633,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28633,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28636_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28637_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28640){
var vec__28641 = p__28640;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28641,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28638){
var G__28639 = cljs.core.first(seq28638);
var seq28638__$1 = cljs.core.next(seq28638);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28639,seq28638__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28655__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28655__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28655__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28655__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28656 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28656,(5),null);
...
var o__26720__auto__ = f;
return (o__26720__auto__["getBasis"]).call(o__26720__auto__);
});
/**
...
}catch (e28660){var _e__26728__auto__ = e28660;
...
var G__28814 = (obj[cljs.core.first(path)]);
var G__28815 = cljs.core.rest(path);
obj = G__28814;
path = G__28815;
continue;
} else {
...
return (function (accum,p__28673){
var vec__28674 = p__28673;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28674,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28674,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28677){
var vec__28678 = p__28677;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28678,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28678,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28678,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28690,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28690,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__28690,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28683_SHARP_){
return (obj[cljs.core.first(p1__28683_SHARP_)]);
});})(name,sorted_matches,vec__28690,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
